...
public class ReleasePagenation {
    ...
    public static ReleaseSelectCriteria getReleaseSelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount){
        ...
        return getReleaseSelectCriteria(pageNo, totalCount, limit, buttonAmount, null, null, null, null);
    }

    /* 검색어가 존재하는 경우 검색 조건으로 select 후 페이징 처리를 하기 위한 용도 */
    public static ReleaseSelectCriteria getReleaseSelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount, String searchCategory, String searchValue, String searchDate, String searchDate2) {
...
//		startPage = (((int)((double) pageNo / buttonAmount + 0.9)) - 1) * buttonAmount + 1;
        ...
        ReleaseSelectCriteria releaseSelectCriteria = new ReleaseSelectCriteria(pageNo, totalCount, limit, buttonAmount ,maxPage, startPage, endPage, startRow, endRow, searchCategory, searchValue, searchDate, searchDate2);
